...
doc = XML::Parser.file("signed.xml").parse
...
doc = XML::Parser.file("encrypted.xml").parse
...
doc.save("encrypted_saml.xml", :indent => true, :encoding => XML::Encoding::UTF_8)
doc = XML::Parser.file("encrypted_saml.xml").parse
